"use strict";
class LifeformDefn {
    constructor(name, durability, speed, damagePerAttack, value, visual, activityDefn) {
        this.name = name;
...
class LifeformDefn_Instances {
    constructor() {
        ...
        var lifeformActivityDefnTodo = new ActivityDefn("Todo", lifeformActivityDefnTodoPerform);
