...
class PlanetDefn_Instances
{
	...
	constructor()
	{
		...
		var visualStation = VisualRectangle.fromColorFillAndSize
		(
			colorGray,
			Coords.ones().multiplyScalar(radiusVicinitySatellite)
		);
		...
		([
			...
			new VisualCircle
			(
				radiusVicinityPrimary * 1.1, null, colorRed, null
			)
		]);
