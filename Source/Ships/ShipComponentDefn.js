...
}
{
	...
	function ShipComponentDefn_Instances()
	{
		...
		var categoryPropulsion = categories.Propulsion;
		...
		this.FusionThruster = new ShipComponentDefn("Fusion Thruster", [ categoryPropulsion ], 100, noEffect);
		this.PowerPlant = new ShipComponentDefn("Power Plant", [ categoryBackbone ], 100, noEffect);
		this.TurningJets = new ShipComponentDefn("Turning Jets", [ categoryPropulsion ], 100, noEffect);
