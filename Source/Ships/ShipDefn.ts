...
class ShipDefn
{
	...
	factionName: string;
	mass: number;
	_accelerationGet: (uwpe: UniverseWorldPlaceEntities) => number;
	speedMax: number;
	_turnsPerTickGet: (uwpe: UniverseWorldPlaceEntities) => number;
	crewInitial: number;
	_crewMaxGet: (uwpe: UniverseWorldPlaceEntities) => number;
	_energyPerTickGet: (uwpe: UniverseWorldPlaceEntities) => number;
	...
	static SpeedDivisor = 32; // Trial and error.
	...
	(
		...
		factionName: string,
		mass: number,
		accelerationGet: (uwpe: UniverseWorldPlaceEntities) => number,
		speedMax: number,
		turnsPerTickGet: (uwpe: UniverseWorldPlaceEntities) => number,
		crewInitial: number,
		crewMaxGet: (uwpe: UniverseWorldPlaceEntities) => number,
		energyPerTickGet: (uwpe: UniverseWorldPlaceEntities) => number,
	...
	)
	{
		...
		(
			...
			factionName,
			mass,
			(uwpe: UniverseWorldPlaceEntities) => accelerationOverSpeedDivisor,
			speedMax,
			(uwpe: UniverseWorldPlaceEntities) => turnsPerTick,
			crewInitial,
			(uwpe: UniverseWorldPlaceEntities) => crewMax,
			(uwpe: UniverseWorldPlaceEntities) => energyPerTick,
			(uwpe: UniverseWorldPlaceEntities) => energyMax,
			costToBuild,
			salvageValue,
			visual,
			attackDefn,
	...
	acceleration(uwpe: UniverseWorldPlaceEntities): number
	{
	...
	energyPerTick(uwpe: UniverseWorldPlaceEntities): number
	{
	...
	turnsPerTick(uwpe: UniverseWorldPlaceEntities): number
	{
...
{
	Aegis: ShipDefn;
	Afterburner: ShipDefn;
	Broadsider: ShipDefn;
	Collapsar: ShipDefn;
	Discus: ShipDefn;
	Efflorescence: ShipDefn;
	Elysian: ShipDefn;
	Encumbrator: ShipDefn;
	Fireblossom: ShipDefn;
	Gravitar: ShipDefn;
	Indemnity: ShipDefn;
	Infernus: ShipDefn;
	Kickback: ShipDefn;
	...
	constructor(universe: Universe)
	{
		...
		var shipDefnFlagship = ShipDefn.fromConstants
		(
			"Flagship",
			null, // namePlural
			"Player", // factionName
		...
		var shipDefnLander = ShipDefn.fromConstants
		(
			"Lander",
			null, // namePlural
			"Player", // factionName
		...
		var shipDefnLahkemupGuardDrone = ShipDefn.fromConstants
		(
			"GuardDrone",
			null, // namePlural
