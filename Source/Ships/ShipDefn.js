...
class ShipDefn_Instances {
    constructor(universe) {
        ...
        0, // energyMax
        0, // value
        ShipDefn.visual(shipDimension, Color.byName("GreenDark"), Color.byName("Red")), attackDefnTodo, null // ?
        );
        ...
        var shipInfernusVisual = new VisualDynamic((universe, world, place, actor) => {
